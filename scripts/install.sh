...
skill_sources=("$repository_dir/skills/gnym-youtrack" "$repository_dir/skills/gnym-commit" "$repository_dir/skills/gnym-branch" "$repository_dir/skills/gnym-pr" "$repository_dir/skills/gnym-undo")
